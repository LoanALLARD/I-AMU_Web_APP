...
> Shell read on every session. Project context and conventions are shared
> sources (Claude Code + Copilot), not duplicated here.

## Project context & conventions

Read first, **before touching code**:

- **Project context** (stack, branches, DB schema, commands, accounts, do/don't): [`docs/project.md`](../docs/project.md)
