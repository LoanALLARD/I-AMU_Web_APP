...
class UserRepository
{
     ...
     *
     * @return list<array{id:int, email:string, first_name:string, last_name:string, is_active:bool, last_login_at:?string, role:string}>
     */
    public function listDepartmentMembers(int $departmentId): array
    {
        ...
        /** @var list<array{id:int, email:string, first_name:string, last_name:string, is_active:bool, last_login_at:?string, role:string}> $rows */
        $rows = $stmt->fetchAll();
     ...
     *
     * @return array{id:int, email:string, first_name:string, last_name:string, is_active:bool, last_login_at:?string, role:string}|null
     */
