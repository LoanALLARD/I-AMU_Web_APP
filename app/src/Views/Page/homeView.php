    ...
    <header class="app-topbar">
        ...
        <div class="topbar-right">
            <div class="topbar-user-avatar"
                title="<?= htmlspecialchars(($user['first_name'] ?? '') . ' ' . ($user['last_name'] ?? '')) ?>">
            ...
            <div class="messages" id="messages">
                ...
                <div class="empty-state" id="emptyState">
                    ...
                    <div class="empty-suggestions">
                        <button class="suggestion-chip" onclick="fillPrompt(this)">Explique-moi les pointeurs en
                            C</button>
                        <button class="suggestion-chip" onclick="fillPrompt(this)">Écris une fonction de tri en
                            Python</button>
                        <button class="suggestion-chip" onclick="fillPrompt(this)">Qu'est-ce que le pattern MVC
                            ?</button>
                    </div>
                </div>
